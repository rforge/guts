...
const int			GNAN_INT 	= std::numeric_limits<int>::quiet_NaN(); // does not work!!!
...
protected:
     ...
     */
    string mTitle;					// Title of the experiment represented by a GUTS object.
    ...
    enum
    {
        ...
        GER_COUNT = 11 // ***RE-COUNT if you add or remove error positions!!!***
    };
