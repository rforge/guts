...
mcmc_result_Proper <- MCMC(p = logposterior, 
  init = mcmc_pars_Proper, scale = mcmc_sigma_Proper, adapt = 20000, acc.rate = 0.4, n = 50000, 
  guts_objects = guts_object, isOutOfBoundsFun = is_out_of_bounds_fun_Proper
)

#exclude burnin and thin by 5
mcmc_result_Proper$samples <- mcmc_result_Proper$samples[seq(30000, 50000, by = 5),]
mcmc_result_Proper$log.p <- mcmc_result_Proper$log.p[seq(30000, 50000, by = 5)]
```
